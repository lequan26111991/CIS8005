...
class Triangle(GeometricObject):
    ...
    def __init__(self, side1 = 1.0, side2 = 1.0, side3 = 1.0, color = "green", filled = True): #Initiate constructor
        ...
        if (self.__side1 < 1):
            raise TriangleError("side 1 caused triangle not being able to form")
        elif(self.__side2 < 1):
            raise TriangleError("side 2 caused triangle not being able to form")
        else:
            raise TriangleError("side 3 caused triangle not being able to form")
